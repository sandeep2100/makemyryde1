function formatDateToCustomString(date) {
    ...
    function populateTimeOptions(selectedDate) {
        ...
        const timeInput = document.getElementById('time_input1');
    ...
    const dateInput = document.getElementById('date_input1');
    ...
    timeInput.addEventListener('click', function() {
        const timeList = document.getElementById('time_list1');
